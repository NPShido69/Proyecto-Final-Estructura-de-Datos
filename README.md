...
- **Daniel Guanga:**
  - Puede ser aplicada en la robótica para la navegación autónoma de robots en entornos complejos.

- **Alexis Guaman:**
  - En el uso en videojuegos para generar niveles de manera procedimental y mejorar la jugabilidad.

- **Luis Coronel:**
  - Puede ser aplicada en la optimización de rutas de entrega en logística, minimizando tiempos de desplazamiento y costos.
